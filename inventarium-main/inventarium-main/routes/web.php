...
Route::post('/venda', 'App\Http\Controllers\VendasController@venda')->name('venda');

Route::get('/relatorios', 'App\Http\Controllers\RelatoriosController@relatorio')->name('relatorios');
